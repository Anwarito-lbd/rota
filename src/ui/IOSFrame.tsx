...
/**
 * iPhone bezel with dynamic island, status bar and home indicator. Below the
 * 900px breakpoint the frame and its chrome are dropped by CSS and the app
 * fills the viewport instead.
 */
export function IOSFrame({ children, dark = true }: Props) {
  return (
    <div className="phone-frame" style={{ background: dark ? '#000' : '#F2F2F7' }}>
      <div
        aria-hidden
      ...
      />
      <div className="phone-chrome" style={{ position: 'absolute', top: 0, left: 0, right: 0, zIndex: 40 }}>
        <StatusBar dark={dark} />
      </div>
